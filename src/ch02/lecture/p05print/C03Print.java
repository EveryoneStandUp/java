...
//		System.out.printf("%n또 다른 정수 %d", "삼백"); // 안됨
//		System.out.printf("%n정수 %d", "3000"); // 안됨
//		System.out.printf("%n정수 %d", 3.14);  // 안됨
		
		// %f : 10진법 실수
		System.out.printf("%n10진법 실수 %f", 3.14);
		System.out.printf("%n10진법 실수 %f", 9.999);
//		System.out.printf("%n10진법 실수 %f", 3); // 안됨 실수만 가능
//		System.out.println("%n10진법 실수 %f", "3.14"); // 안됨
